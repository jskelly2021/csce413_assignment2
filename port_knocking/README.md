...
* When it gets a knock, it updates a registry of IP addresses and previous knocks and their times.
* It then checks:
...
### Example Usage
* WARNING: Only run in the server script in a container. Flushes all entries of the iptable when server starts.
